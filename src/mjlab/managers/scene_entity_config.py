...
_FIELD_CONFIGS = [
  ...
  _FieldConfig("ctrl_names", "ctrl_ids", "find_ctrls", "num_ctrls", "ctrl"),
]
...
class SceneEntityCfg:
  ...
  Attributes:
    ...
    ctrl_names: Names of MuJoCo control actuators (joint names) to include.
      Can be a single string or tuple. Use patterns like ".*_hip_.*" to match multiple joints.
    ctrl_ids: IDs of MuJoCo control actuators to include. Can be a list or slice.
  ...
  ctrl_names: str | tuple[str, ...] | None = None
  ctrl_ids: list[int] | slice = field(default_factory=lambda: slice(None))
